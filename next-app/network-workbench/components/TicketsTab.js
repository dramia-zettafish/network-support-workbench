...
export default function TicketsTab({ initialOpenTicket = null, initialOpenTicketNumber = null, showCreate = true }) {
    ...
    },
    {
      ...
      render: (ticket) => (
        <div className={styles.rowActions}>
          <button type="button" className="secondaryButton compactButton" onClick={(event) => openEditModal(event, ticket)} disabled={writeDisabled}>Edit</button>
          <button type="button" className="dangerButton compactButton" onClick={(event) => openDeleteConfirm(event, ticket)} disabled={writeDisabled}>Delete</button>
        </div>
      )
    }
  ];
  ...
  async function handleCreateTicket(event) {
    ...
    setFormError('');
    if (writeDisabled) {
      setFormError('Write operations are disabled.');
  ...
  function renderDeviceFields(title, fields, disabled = false) {
    const fieldDisabled = disabled || writeDisabled;
    return (
    ...
    return (
      <SpotlightPanel as="label" className={styles.fullWidthLabel} mode="interactive">
        ...
        <textarea
          ...
          maxLength={2000}
          rows={rows}
          disabled={responseClosed || writeDisabled}
        />
      </SpotlightPanel>
    );
  }
      ...
      <>
        ...
        <SpotlightPanel as="section" className={styles.responsePhase} mode="interactive">
          <div className={styles.phaseHeader}>
            ...
            {!responseClosed && <button type="button" className="secondaryButton compactButton" onClick={addUpsDevice} disabled={writeDisabled}>Add UPS</button>}
          </div>
              ...
              <SpotlightPanel className={styles.responseFieldset} mode="interactive" key={`ups-${index}`}>
                <div className={styles.phaseHeader}>
                  ...
                  {index > 0 && !responseClosed && (
                    <button type="button" className="dangerButton compactButton" onClick={() => removeUpsDevice(index)} disabled={writeDisabled}>Remove</button>
                  )}
                </div>
                <div className={styles.responseGrid}>
                  {[
        ...
        <SpotlightPanel as="section" className={styles.responsePhase} mode="interactive">
          <div className={styles.phaseHeader}>
            <h3>Battery Packs</h3>
            {!responseClosed && <button type="button" className="secondaryButton compactButton" onClick={addBatteryPack} disabled={writeDisabled}>Add Battery Pack</button>}
          </div>
              ...
              {batteryPacks.map((pack, index) => (
                <SpotlightPanel className={styles.responseFieldset} mode="interactive" key={`battery-${index}`}>
                  <div className={styles.phaseHeader}>
                    ...
                    {!responseClosed && <button type="button" className="dangerButton compactButton" onClick={() => removeBatteryPack(index)} disabled={writeDisabled}>Remove</button>}
                  </div>
                  <div className={styles.responseGrid}>
                    <label>
                      SN
                      <input value={pack.sn} onChange={(event) => updateBatteryPack(index, 'sn', event.target.value)} maxLength={100} disabled={responseClosed || writeDisabled} />
                    </label>
                    <label>
                      Asset Tag
                      <input value={pack.asset_tag} onChange={(event) => updateBatteryPack(index, 'asset_tag', event.target.value)} maxLength={100} disabled={responseClosed || writeDisabled} />
                    </label>
                  </div>
                </SpotlightPanel>
              ))}
        ...
        <div className={styles.actions}>
          <button type="button" className="primaryButton" onClick={handleReviewUpsResponse} disabled={responseClosed || writeDisabled}>
        ...
        {showCreate && (
          <SectionCard title="Create New Ticket">
            <form className={styles.form} onSubmit={handleCreateTicket}>
              ...
              <div className={styles.actions}>
                <button type="submit" className="primaryButton" disabled={savingTicket || writeDisabled}>
            ...
            <div className={styles.responseModal}>
              {reviewCopyConfig ? (
                ...
                <>
                  ...
                  <div className={styles.actions}>
                    <button type="button" className="primaryButton" onClick={handleReviewRmaEmail} disabled={writeDisabled}>
              ...
              {responseForm.resolution_type === 'no_replacement' ? (
                <>
                  ...
                  <div className={styles.actions}>
                    <button type="button" className="primaryButton" onClick={handleReviewNoReplacementResponse} disabled={responseClosed || writeDisabled}>
                ...
                <>
                  ...
                  <div className={styles.actions}>
                    <button type="button" className="primaryButton" onClick={handleReviewPermanentResponse} disabled={responseClosed || writeDisabled}>
                      Review & Copy Response
                    </button>
                    <button type="button" className="secondaryButton" onClick={closeResponseModal}>Close</button>
                  </div>
                ...
                <>
                  {!showRmaOnly && (
                    <SpotlightPanel as="section" className={styles.responsePhase} mode="interactive">
                      ...
                      <div className={styles.actions}>
                        <button type="button" className="primaryButton" onClick={handleReviewTempResponse} disabled={responseClosed || writeDisabled}>
                  ...
                  {rmaPhaseUnlocked && (
                    <SpotlightPanel as="section" className={styles.responsePhase} mode="interactive">
                      ...
                      <div className={styles.actions}>
                        <button type="button" className="primaryButton" onClick={handleReviewRmaResponse} disabled={responseClosed || writeDisabled}>
      ...
      {editingTicket && (
        <Modal title="Edit Ticket" onClose={closeEditModal}>
          <form className={styles.form} onSubmit={handleUpdateTicket}>
            ...
            <div className={styles.actions}>
              <button type="submit" className="primaryButton" disabled={updatingTicket || writeDisabled}>
      ...
      {deleteConfirmTicket && (
        <Modal title="Delete this record?" onClose={closeDeleteConfirm}>
          ...
          <div className={styles.actions}>
            ...
            <button type="button" className="dangerButton" onClick={handleConfirmDeleteTicket} disabled={deletingTicket || writeDisabled}>
